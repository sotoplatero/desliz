...
var require_dist_node9 = __commonJS({
  "node_modules/@octokit/plugin-request-log/dist-node/index.js"(exports) {
    ...
    function requestLog(octokit2) {
      octokit2.hook.wrap("request", (request, options2) => {
        ...
        return request(options2).then((response) => {
          ...
          octokit2.log.info(`${requestOptions.method} ${path} - ${error3.status} in ${Date.now() - start}ms`);
          throw error3;
        });
      });
    }
...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-14ca1587.js",
      css: ["/./_app/assets/start-a97448ed.css"],
      js: ["/./_app/start-14ca1587.js", "/./_app/chunks/vendor-8ffe5f49.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "android-chrome-192x192.png", "size": 3626, "type": "image/png" }, { "file": "android-chrome-512x512.png", "size": 10239, "type": "image/png" }, { "file": "apple-touch-icon.png", "size": 3387, "type": "image/png" }, { "file": "favicon-16x16.png", "size": 306, "type": "image/png" }, { "file": "favicon-32x32.png", "size": 529, "type": "image/png" }, { "file": "favicon.ico", "size": 15406, "type": "image/vnd.microsoft.icon" }, { "file": "logo.png", "size": 3387, "type": "image/png" }, { "file": "robots.txt", "size": 70, "type": "text/plain" }, { "file": "site.webmanifest", "size": 263, "type": "application/manifest+json" }],
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/cartel\/([^/]+?)\/?$/,
      params: (m) => ({ id: d(m[1]) }),
      a: ["src/routes/cartel/__layout.reset.svelte", "src/routes/cartel/[id].svelte"],
      b: []
    },
    {
      type: "endpoint",
    ...
    },
    {
      ...
      pattern: /^\/img\/([^/]+?)\/?$/,
      params: (m) => ({ text: d(m[1]) }),
      a: ["src/routes/__layout.svelte", "src/routes/img/[text].svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
      pattern: /^\/([^/]+?)\/?$/,
      params: (m) => ({ text: d(m[1]) }),
      a: ["src/routes/__layout.svelte", "src/routes/[text].svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/cartel/__layout.reset.svelte": () => Promise.resolve().then(function() {
    return __layout_reset;
  }),
  "src/routes/cartel/[id].svelte": () => Promise.resolve().then(function() {
    return _id_;
  }),
  "src/routes/img/[text].svelte": () => Promise.resolve().then(function() {
    return _text_$1;
  }),
  "src/routes/[text].svelte": () => Promise.resolve().then(function() {
    return _text_;
  })
};
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-d7763723.js", "css": ["/./_app/assets/pages/__layout.svelte-81cf1fda.css"], "js": ["/./_app/pages/__layout.svelte-d7763723.js", "/./_app/chunks/vendor-8ffe5f49.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-61491671.js", "css": [], "js": ["/./_app/error.svelte-61491671.js", "/./_app/chunks/vendor-8ffe5f49.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-6341f341.js", "css": [], "js": ["/./_app/pages/index.svelte-6341f341.js", "/./_app/chunks/vendor-8ffe5f49.js"], "styles": null }, "src/routes/cartel/__layout.reset.svelte": { "entry": "/./_app/pages/cartel/__layout.reset.svelte-31a01329.js", "css": [], "js": ["/./_app/pages/cartel/__layout.reset.svelte-31a01329.js", "/./_app/chunks/vendor-8ffe5f49.js"], "styles": null }, "src/routes/cartel/[id].svelte": { "entry": "/./_app/pages/cartel/[id].svelte-1a5ee02a.js", "css": [], "js": ["/./_app/pages/cartel/[id].svelte-1a5ee02a.js", "/./_app/chunks/vendor-8ffe5f49.js", "/./_app/chunks/cartel-f2300e6b.js"], "styles": null }, "src/routes/img/[text].svelte": { "entry": "/./_app/pages/img/[text].svelte-34511ad5.js", "css": [], "js": ["/./_app/pages/img/[text].svelte-34511ad5.js", "/./_app/chunks/vendor-8ffe5f49.js", "/./_app/chunks/cartel-f2300e6b.js"], "styles": null }, "src/routes/[text].svelte": { "entry": "/./_app/pages/[text].svelte-755433f7.js", "css": [], "js": ["/./_app/pages/[text].svelte-755433f7.js", "/./_app/chunks/vendor-8ffe5f49.js"], "styles": null } };
...
var octokit$1 = new import_rest.Octokit({
  auth: {}.VITE_GITHUB_ACCESS_TOKEN
});
async function get$2({ params }) {
  const { data } = await octokit$1.rest.repos.getContent({
    owner: "sotoplatero",
    repo: "data",
    path: `cartelkit/${params.code}`
  });
  const img = JSON.parse(_atob(data.content));
  return { body: img };
}
var _code__json = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  get: get$2
});
var nanoid = customAlphabet("1234567890abcdefghijklmnopqrstuvwxyzABCDEGHYJKLMNOPQESTVWXYZ", 10);
var host$1 = "https://cartelkit.herokuapp.com";
var octokit = new import_rest.Octokit({
  auth: {}.VITE_GITHUB_ACCESS_TOKEN
});
async function post({ query, body }) {
  let { src: src2, text } = JSON.parse(body);
  const res = await fetch(host$1 + src2 + "&data=true");
  const img = await res.text();
  content = { text, img };
  const contentEncoded = _btoa(JSON.stringify(content));
  const id = nanoid();
...
async function get$1({ params, query }) {
  const files = import_fs.default.readdirSync(base + `./src/themes/cartel/`).map((el) => el.replace(/\.html$/, ""));
  return { body: files };
}
var themes_json = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  get: get$1
});
var host = "https://cartelkit.herokuapp.com";
async function get({ params, query }) {
  let data = query.get("data") === "true";
  const url = `${host}/${encodeURI(params.text)}.png?${query.toString()}`;
  const res = await fetch(url);
  const image = !data ? await res.buffer() : await res.text();
  const contentType = !data ? "application/octet-stream" : "text/plain";
  const img = !data ? Buffer.from(image) : image;
  return {
    headers: { "Content-Type": contentType },
    body: img
  };
}
var _text__png = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  get
});
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"max-w-screen-md mx-auto w-full px-2"}"><h1 class="${"text-xl sm:text-3xl text-center py-4 font-bold flex items-center justify-center"}"><img src="${"/logo.png"}" class="${"w-10 h-10 rounded-md mr-2"}" alt="${""}">	
		<span class="${"text-gray-800"}">CartelKit</span></h1>

	${slots.default ? slots.default({}) : ``}

  <footer class="${"my-12 text-center"}">Hecho con las \u270B y el \u{1F493} en \u{1F3E0} por <a href="${"https://twitter.com/sotoplatero"}" class="${"text-blue-500"}">@sotoplatero</a><br></footer></div>`;
});
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let text = "Genera im\xE1genes desde la URL";
  let bgs = [
    "DC2626",
    "D97706",
    "10B981",
  ...
  async function setSrc() {
    ...
    let cleanBg = bg.replace(/#/, "");
    url = `${encodeURIComponent(text)}.png?color=${cleanColor}&bg=${cleanBg}`;
    src2 = `/img/${url}`;
  }
  src2 && (loading = true);
  return `<main><div class="${"flex space-x-1 mb-2"}"><div class="${"w-full"}"><label for="${"text"}">Cartel</label>
			<input name="${"text"}" class="${"p-3 w-full border"}"${add_attribute("value", text, 1)}></div>
		<div class="${"w-10 sm:w-32"}"><label for="${"color"}">Texto</label>
			<input name="${"color"}" type="${"color"}" class="${"p-3 w-full border h-12"}"${add_attribute("value", color, 1)}></div>
		<div class="${"w-10 sm:w-32"}"><label for="${"bg"}">Fondo</label>
			<input name="${"bg"}" type="${"color"}" class="${"p-3 w-full border h-12"}"${add_attribute("value", bg, 1)}></div></div>

	${src2 ? `<a${add_attribute("href", url, 0)} class="${"aspect-w-16 aspect-h-9 block"}"><img${add_attribute("alt", text, 0)}${add_attribute("src", src2, 0)}${add_attribute("style", loading ? "filter: blur(8px);" : "", 0)} class="${"border rounded-xl " + escape2(loading ? "blur" : "")}"></a>

		<div class="${"flex items-center mt-2"}"><button>Comparte
			</button>
			${``}</div>

		<div class="${"my-8"}"><pre class="${"p-3 px-4 w-full bg-gray-200 overflow-auto select-all"}"><code>&lt;img src=&quot;https://cartelkit.dsoto.dev${escape2(src2)}&quot; alt=&quot;texto&quot;&gt;
			</code></pre></div>` : ``}


	<div class="${"space-y-10"}"><div><h2>Texto autoajustable</h2>
			<p>El tama\xF1o del texto se ajusta al formato y las dimensiones de la imagen</p>
			<div><img src="${"https://cartelkit.dsoto.dev/El-tama\xF1o-del-texto-se-ajusta"}" alt></div></div>

		<div><h2>Tama\xF1os y aspectos variables</h2></div>

		<div><h2>Incluye tus emojis</h2></div></div></main>`;
});
...
var _layout_reset = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"max-w-screen-lg mx-auto w-full px-2"}"><h1 class="${"text-2xl sm:text-4xl text-center py-2 font-bold flex items-center justify-center"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" class="${"h-8 w-8 sm:h-12 sm:w-12 text-pink-700 mr-2"}" fill="${"none"}" viewBox="${"0 0 24 24"}" stroke="${"currentColor"}"><path stroke-linecap="${"round"}" stroke-linejoin="${"round"}" stroke-width="${"2"}" d="${"M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"}"></path></svg>		
		<span class="${"text-gray-800"}">CartelKit</span></h1>

	${slots.default ? slots.default({}) : ``}

  <footer class="${"my-1 text-right"}">por <a href="${"https://twitter.com/sotoplatero"}" class="${"text-blue-500"}">@sotoplatero</a><br></footer></div>`;
});
...
var Cartel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { cartel = {} } = $$props;
  if ($$props.cartel === void 0 && $$bindings.cartel && cartel !== void 0)
    $$bindings.cartel(cartel);
  return `<div><img${add_attribute("src", cartel.img, 0)}${add_attribute("alt", cartel.text, 0)} class="${"border rounded-xl"}"></div>`;
});
async function load$1({ page: page2, fetch: fetch22 }) {
  const res = await fetch22(`/cartel/${page2.params.id}.json`);
  const cartel = await res.json();
  return { props: { cartel } };
}
var U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.cartel === void 0 && $$bindings.cartel && cartel !== void 0)
    $$bindings.cartel(cartel);
  return `${$$result.head += `<meta name="${"og:image"}" content="${"https://kartelkit.dsoto.dev"}" data-svelte="svelte-18guygj"><meta name="${"og:url"}" content="${"https://useimg.dsoto.dev"}" data-svelte="svelte-18guygj">`, ""}

${validate_component(Cartel, "Cartel").$$render($$result, { cartel }, {}, {})}`;
});
...
async function load({ page: page2, fetch: fetch22 }) {
  let { text } = page2.params;
  text = encodeURIComponent(text);
  const res = await fetch22(`/img/${text}.text?${page2.query.toString()}`);
  const img = await res.text();
  const src2 = `/img/${text}.png?${page2.query.toString()}`;
  return { props: { cartel: { text, img, src: src2 } } };
}
var U5Btextu5D$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { cartel } = $$props;
  if ($$props.cartel === void 0 && $$bindings.cartel && cartel !== void 0)
    $$bindings.cartel(cartel);
  return `${validate_component(Cartel, "Cartel").$$render($$result, { cartel }, {}, {})}`;
});
var _text_$1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": U5Btextu5D$1,
  load
});
var getStores = () => {
...
var U5Btextu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $page, $$unsubscribe_page;
  $$unsubscribe_page = subscribe(page, (value) => $page = value);
  let src2 = `/img/${$page.params.text}.png?${$page.query.toString()}`;
  $$unsubscribe_page();
  return `



<div><img${add_attribute("src", src2, 0)}${add_attribute("alt", $page.params.text, 0)} class="${"border rounded-xl"}"></div>`;
});
var _text_ = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": U5Btextu5D
});
